...
class ExpansionAuthenticator(context: Context) : AbstractAccountAuthenticator(context) {
    ...
    override fun addAccount(r: AccountAuthenticatorResponse, s: String, s2: String, strings: Array<String>,
