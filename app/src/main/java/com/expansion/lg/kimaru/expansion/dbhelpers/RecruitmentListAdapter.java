...
public class RecruitmentListAdapter extends RecyclerView.Adapter<RecruitmentListAdapter.ListHolder>{
    private Context mContext;
    private List<Recruitment> recruitments;
    private RecruitmentListAdapterListener listener;
    ...
    public RecruitmentListAdapter(Context mContext, List<Recruitment> recruitments, RecruitmentListAdapterListener listener){
    ...
    private void applyProfilePicture(ListHolder holder, Recruitment recruitment) {
        if (!TextUtils.isEmpty(recruitment.getPicture())) {
            Glide.with(mContext).load(recruitment.getPicture())
                    .thumbnail(0.5f)
                    .crossFade()
    ...
    public interface RecruitmentListAdapterListener {
