...
public class ExamListAdapter extends RecyclerView.Adapter<ExamListAdapter.ListHolder>{
    private Context mContext;
    private List<Exam> exams;
    private ExamListAdapterListener listener;
    ...
    public ExamListAdapter(Context mContext, List<Exam> exams, ExamListAdapterListener listener){
    ...
    private void applyProfilePicture(ListHolder holder, Exam exam) {
    ...
    private void applyReadStatus(ListHolder holder, Exam exam) {
        if (exam.isRead()) {
