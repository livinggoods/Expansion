...
public class CommunityUnitListAdapter extends RecyclerView.Adapter<CommunityUnitListAdapter.ListHolder>{
    private Context mContext;
    private List<CommunityUnit> communityUnits;
    private CommunityUnitListAdapterListener listener;
    ...
    public CommunityUnitListAdapter(Context mContext, List<CommunityUnit> communityUnits, CommunityUnitListAdapterListener listener){
    ...
    private void applyProfilePicture(ListHolder holder, CommunityUnit communityUnit) {
    ...
    private void applyImportant(ListHolder holder, CommunityUnit communityUnit) {
    ...
    private void applyReadStatus(ListHolder holder, CommunityUnit communityUnit) {
    ...
    public interface CommunityUnitListAdapterListener {
