        ...
        if (!Environment.MEDIA_MOUNTED.equals(state)){
            ...
            for (CommunityUnit cm:communityUnits){
                String detailsLine = cm.getId()+","
                        + cm.getCommunityUnitName().replaceAll(",", ";")+","
                        + cm.getMappingId().replaceAll(",", ";")+","
                        + cm.getLat().toString()+","
                        + cm.getLon().toString()+","
                        + cm.getCountry().replaceAll(",",";")+","
                        + cm.getSubCountyId().replaceAll(",",";")+","
                        + cm.getLinkFacilityId().replaceAll(",",";")+","
                        + cm.getAreaChiefName().replaceAll(",",";")+","
                        + cm.getAreaChiefPhone().replaceAll(",",";")+","
                        + cm.getWard().replaceAll(",",";")+","
                        + cm.getEconomicStatus().replaceAll(",",";")+","
                        + cm.getPrivateFacilityForAct().replaceAll(",",";")+","
                        + cm.getPrivateFacilityForMrdt().replaceAll(",",";")+","
                        + cm.getNameOfNgoDoingIccm().replaceAll(",",";")+","
                        + cm.getNameOfNgoDoingMhealth().replaceAll(",",";")+","
                        + cm.getDateAdded()+","
