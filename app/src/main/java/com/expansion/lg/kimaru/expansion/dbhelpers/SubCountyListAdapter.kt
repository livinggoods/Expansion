...
class SubCountyListAdapter(private val mContext: Context, private val subCounties: MutableList<SubCounty>, private val listener: SubCountyListAdapterListener) : RecyclerView.Adapter<SubCountyListAdapter.ListHolder>() {
    ...
    override fun onBindViewHolder(holder: ListHolder, position: Int) {
        ...
        holder.from.text = subCounty.subCountyName
        holder.subject.text = subCounty.contactPerson
        holder.message.text = subCounty.contactPersonPhone
        val dateAdded = Date(subCounty.dateAdded!! * 1000)
        ...
        holder.iconText.text = subCounty.subCountyName.substring(0, 1)
    ...
    private fun applyProfilePicture(holder: ListHolder, subCounty: SubCounty) {
    ...
    private fun applyImportant(holder: ListHolder, subCounty: SubCounty) {
    ...
    private fun applyReadStatus(holder: ListHolder, subCounty: SubCounty) {
    ...
    interface SubCountyListAdapterListener {
