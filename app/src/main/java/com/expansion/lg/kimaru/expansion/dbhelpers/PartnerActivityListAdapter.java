...
public class PartnerActivityListAdapter extends RecyclerView.Adapter<PartnerActivityListAdapter.ListHolder>{
    private Context mContext;
    private List<PartnerActivity> partnerActivities;
    private PartnerActivityListAdapterListener listener;
    ...
    public PartnerActivityListAdapter(Context mContext, List<PartnerActivity> activities, PartnerActivityListAdapterListener listener){
    ...
    public void onBindViewHolder(final ListHolder holder, final int position){
        PartnerActivity partnerActivity = partnerActivities.get(position);
        PartnerActivityTable partnerActivityTable = new PartnerActivityTable(mContext);
        Log.d("=====","================================================================");
        Log.d("Tremap",partnerActivity.getPartnerId());
        Log.d("=====","================================================================");

        Partners partner = new PartnersTable(mContext).getPartnerById(partnerActivity.getPartnerId());

        //// displaying text view data
        holder.from.setText(partner.getPartnerName());
        holder.subject.setText(partner.getContactPerson());
        holder.message.setText(partner.getContactPersonPhone());

        holder.timestamp.setText(new DisplayDate(partner.getDateAdded()).dateAndTime());

        // displaying the first letter of From in icon text
        holder.iconText.setText(partner.getPartnerName().substring(0,1));
    ...
    private void applyProfilePicture(ListHolder holder, Partners partner) {
        holder.imgProfile.setImageResource(R.drawable.bg_circle);
        holder.imgProfile.setColorFilter(partner.getColor());
    ...
    private void applyImportant(ListHolder holder, PartnerActivity partnerActivity) {
    ...
    private void applyReadStatus(ListHolder holder, PartnerActivity partnerActivity) {
    ...
    public void removeData(int position) {
        partnerActivities.remove(position);
        resetCurrentIndex();
    }
    ...
    public interface PartnerActivityListAdapterListener {
