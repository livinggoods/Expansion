...
class RegistrationListAdapter(private val mContext: Context, private val registrations: MutableList<Registration>, private val listener: RegistrationListAdapterListener) : RecyclerView.Adapter<RegistrationListAdapter.ListHolder>() {
    ...
    override fun onBindViewHolder(holder: ListHolder, position: Int) {
        ...
        holder.subject.text = registration.phone
        holder.message.text = registration.name
        holder.timestamp.text = DisplayDate(registration.dateAdded!!.toLong()).dateOnly()
    ...
    private fun applyProfilePicture(holder: ListHolder, message: Registration) {
    ...
    private fun applyImportant(holder: ListHolder, message: Registration) {
    ...
    private fun applyReadStatus(holder: ListHolder, message: Registration) {
        if (message.proceed == 1) {
    ...
    fun removeData(position: Int) {
        registrations.removeAt(position)
        resetCurrentIndex()
    }
    ...
    interface RegistrationListAdapterListener {
