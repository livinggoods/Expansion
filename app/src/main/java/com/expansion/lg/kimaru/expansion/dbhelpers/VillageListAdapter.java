...
public class VillageListAdapter extends RecyclerView.Adapter<VillageListAdapter.ListHolder>{
    private Context mContext;
    private List<Village> villages;
    private VillageListAdapterListener listener;
    ...
    public VillageListAdapter(Context mContext, List<Village> villages, VillageListAdapterListener listener){
    ...
    private void applyProfilePicture(ListHolder holder, Village village) {
        if (!TextUtils.isEmpty(village.getPicture())) {
            Glide.with(mContext).load(village.getPicture())
                    .thumbnail(0.5f)
                    .crossFade()
            ...
            holder.imgProfile.setColorFilter(village.getColor());
    ...
    public interface VillageListAdapterListener {
