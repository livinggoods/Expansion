 ...
 * {@link PartnerActivityFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link PartnerActivityFragment#newInstance} factory method to
...
public class PartnerActivityFragment extends Fragment  {
    ...
    private PartnerActivityListAdapter rAdapter;
    ...
    public static PartnerActivityFragment newInstance(String param1, String param2) {
        PartnerActivityFragment fragment = new PartnerActivityFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rAdapter = new PartnerActivityListAdapter(this.getContext(), partnerActivities, new PartnerActivityListAdapter.PartnerActivityListAdapterListener() {
            @Override
    ...
    *  Color
    ...
    private void getPartnerActivities() {
        ...
        try {
            ...
            PartnerActivityTable activityTable = new PartnerActivityTable(getContext());
            List<PartnerActivity> activities = new ArrayList<>();

            activities = activityTable.getPartnerActivityByField(PartnerActivityTable.SUBCOUNTY,
                    session.getSavedSubCounty().getId());
            for (PartnerActivity activity:activities){
                activity.setColor(getRandomMaterialColor("400"));
            ...
            textshow.setText("No data to display");
