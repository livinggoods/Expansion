...
public class RegistrationSyncServiceAdapter extends AbstractThreadedSyncAdapter {
    public  static final int SYNC_INTERVAL = 15;
    public  static final int SYNC_FLEXTIME = SYNC_INTERVAL/3;
    public static final int NOTIFICATION_ID = 3004;

    public RegistrationSyncServiceAdapter(Context context, boolean autoInitialize){
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
        ...
        RegistrationSyncServiceAdapter.configurePeriodicSync(context, SYNC_INTERVAL, SYNC_FLEXTIME);
